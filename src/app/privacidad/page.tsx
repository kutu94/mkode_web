    ...
    <main className="min-h-screen py-32">
      <article className="container mx-auto max-w-4xl px-6">
        ...
        <div className="mb-12 rounded-2xl border border-amber-400/30 bg-amber-400/10 p-5 text-sm leading-relaxed text-amber-100" role="note">
          Este documento es un borrador operativo y debe recibir revisión jurídica antes de su publicación definitiva.
        </div>
        ...
        <div className="space-y-10 text-sm leading-7 text-white/70 md:text-base">
          <section>
            ...
            <p className="mt-3">
              ...
              Domicilio: 30 N Gould St, Ste R, Sheridan, WY 82801, USA<br />
              Contacto: <a className="text-primary-blue underline" href="mailto:marcos.quintana@mkode.es">marcos.quintana@mkode.es</a>
            </p>
          </section>

          <section>
            <h2 className="mb-3 text-xl font-bold text-white">2. Datos que tratamos</h2>
            <p>Podemos tratar nombre, cargo profesional, empresa, correo corporativo, ubicación profesional e información pública relevante sobre la actividad de la empresa. También registramos el estado de la comunicación y eventos técnicos de entrega, apertura, clic, respuesta, rebote o baja cuando el proveedor de correo los facilita.</p>
          </section>

          <section>
            <h2 className="mb-3 text-xl font-bold text-white">3. Origen de los datos</h2>
            <p>Los datos pueden proceder de fuentes públicas, sitios web corporativos, directorios y redes profesionales, proveedores de verificación de correo o de la información que usted nos comunique directamente.</p>
          </section>

          <section>
            <h2 className="mb-3 text-xl font-bold text-white">4. Finalidades</h2>
            <p>Utilizamos los datos para evaluar si los servicios de automatización e integración de MKode pueden resultar relevantes para una empresa, realizar comunicaciones comerciales B2B personalizadas, gestionar respuestas y reuniones, medir el funcionamiento técnico de la campaña y mantener una lista mínima de supresión cuando una persona solicita no recibir más comunicaciones.</p>
          </section>

          <section>
            <h2 className="mb-3 text-xl font-bold text-white">5. Proveedores y transferencias</h2>
            <p>Para operar estos procesos podemos utilizar proveedores de correo, alojamiento, automatización, almacenamiento, hojas de cálculo e inteligencia artificial, incluidos Brevo, Google, n8n y proveedores tecnológicos equivalentes. Estos proveedores pueden tratar datos por cuenta de MKode y operar desde otros países conforme a sus condiciones y mecanismos legales aplicables.</p>
          </section>
