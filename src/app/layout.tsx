            ...
            <div className="container mx-auto px-6">
              <div className="mb-12 grid grid-cols-1 gap-10 md:mb-16 md:grid-cols-4 md:gap-12">
                <div className="col-span-1 md:col-span-2">
                  <Link href="/" className="mb-6 flex items-center gap-3"><LogoIcon className="h-6 w-6 text-primary-blue" /><span className="text-lg font-bold tracking-tighter text-white">MKode</span></Link>
                  <p className="max-w-sm text-sm leading-relaxed text-white/70">Ingeniería de sistemas inteligentes para optimizar operaciones de empresas en crecimiento.</p>
                  <Link href="/consultoras-mexico" className="mt-4 inline-flex rounded-sm text-sm text-blue-300 underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-300">Conozca el sprint para consultoras en México</Link>
                </div>
